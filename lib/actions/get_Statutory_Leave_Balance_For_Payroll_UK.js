...
exports.process = function process(msg, cfg) {
  ...
  const url = `https://api.xero.com/payroll.xro/2.0/employees/${msg.body.EmployeeID}/statutoryleaveBalance?leaveType=${msg.body.leaveType}&asOfDate=${msg.body.asOfDate}`;
